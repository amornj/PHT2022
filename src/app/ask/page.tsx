...
const exampleQuestions = [
  'What are the 2022 hemodynamic definitions for pulmonary hypertension?',
  'How do I differentiate pre-capillary from post-capillary PH?',
  'What is the initial treatment for high-risk PAH?',
  'When should V/Q scan be performed vs CT angiography?',
  'What are the criteria for positive vasoreactivity testing?',
  'What drugs are contraindicated in PAH?',
  'How is CTEPH diagnosed and treated?',
  'What is the four-strata risk model at follow-up?',
]
    ...
    <div className="flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-3rem)]">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-gray-500">AI-powered Q&A on the 2022 ESC/ERS PH Guidelines</p>
        </div>
        {messages.length > 0 && (
      ...
      <div className="flex-1 overflow-y-auto space-y-3 mb-4">
        {messages.length === 0 && !loading && (
          <div className="space-y-3">
            <p className="text-sm text-gray-500">Ask any question about the 2022 ESC/ERS Pulmonary Hypertension Guidelines:</p>
      ...
      <div className="border-t pt-3 space-y-2">
        <form onSubmit={(e) => { e.preventDefault(); handleSend() }} className="flex gap-2">
          <input
            ...
            placeholder="Ask about PH guidelines..."
