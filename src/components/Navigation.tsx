  ...
  const NavContent = () => (
    <>
      <div className="p-4 border-b border-white/20">
        <h1 className="text-xl font-bold text-white">PHT2022</h1>
        <p className="text-xs text-blue-200 mt-1">Pulmonary Hypertension<br />Clinical Guide</p>
        <p className="text-[10px] text-blue-300/70 mt-1">2022 ESC/ERS Guidelines</p>
      </div>
